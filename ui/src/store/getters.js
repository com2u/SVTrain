...
const getters = {
  ...
  canSeeDefectMethod: (state) => getPermissions(state) && state.app.user.permissions.defectMethod,
  ...
  defaultZoom: (state) => state.app.config.defaultZoom || state.app.explorerConfig.defaultZoom || 70,
